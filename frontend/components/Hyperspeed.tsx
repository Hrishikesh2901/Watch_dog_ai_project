...
const Hyperspeed = ({
  ...
  useEffect(() => {
    ...
    class CarLights {
      ...
      update(time: number) {
        if (this.mesh) (this.mesh.material as any).uniforms.uTime.value = time;
      }
    }
    ...
    (function () {
      ...
      console.log("Hyperspeed init started", container);
      ...
      try {
          ...
          myApp.loadAssets().then(myApp.init).catch(e => console.error("Hyperspeed asset load error", e));
      } catch (e) {
