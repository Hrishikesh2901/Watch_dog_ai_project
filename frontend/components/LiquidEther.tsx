...
`;
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(props: any) {
        ...
        if (this.mouse) {
            ...
            (uniforms as any).force.value.set(forceX, forceY);
            (uniforms as any).center.value.set(centerX, centerY);
            (uniforms as any).scale.value.set(props.cursor_size, props.cursor_size);
        }
        super.update();
      }
    }
    ...
    class Output {
      ...
      constructor() {
        this.simulation = new Simulation({}); // args will be overwritten by options object
        this.init();
      }
      init() {
        this.scene = new THREE.Scene();
