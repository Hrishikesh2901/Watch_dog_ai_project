...
export default function UserDashboard() {
    ...
    const fetchReports = async () => {
        try {
            const res = await axios.get('http://127.0.0.1:8000/api/my-reports', {
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex space-x-4 mb-8 border-b border-slate-200 dark:border-slate-800">
                    <button
                        ...
                        className={`pb-3 px-1 font-medium text-sm transition-colors border-b-2 ${activeTab === 'reports'
                    ...
                    <button
                        ...
                        className={`pb-3 px-1 font-medium text-sm transition-colors border-b-2 ${activeTab === 'profile'
                                ? 'border-blue-600 text-blue-600 dark:text-blue-400'
                                : 'border-transparent text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'
                            }`}
                    >
                            ...
                            <div className="space-y-4">
                                {reports.map((report) => (
                                    <div
                                        ...
                                        className={`p-4 rounded-xl border cursor-pointer transition-all ${activeReport?.id === report.id
                                    ...
                                    >
                                        <div className="flex justify-between items-start mb-2">
                                            ...
                                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${report.status === 'Approved' ? 'bg-green-100 text-green-700' :
